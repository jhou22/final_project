    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('join_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='account creation date')),
                ('dob', models.DateField(verbose_name='date of birth')),
                ('profile_picture', models.ImageField(default='default-profile-icon.png', upload_to='', verbose_name='profile picture')),
